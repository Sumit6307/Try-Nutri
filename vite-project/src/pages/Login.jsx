...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-y-auto scroll-smooth">
      ...
      <Element
        name="welcome"
        className="h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white relative pt-24 px-6 overflow-hidden"
      >
      ...
      {/* Pricing Section */}
      <Element name="pricing" className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white px-6 py-20 flex flex-col items-center justify-center">
    ...
    <RouterLink to="/forgot-password" className="text-sm text-green-400 hover:underline">
      Forgot Password?
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            New to NutriAI?{' '}
            <RouterLink to="/register" className="text-green-400 hover:underline font-medium">
              Sign Up
            </RouterLink>
          </p>
